...
const GLOBAL_EXERCISES: {
  ...
  // Cardio — muscleGroup = catalog subgroup (Standard vs HIIT)
  { name: 'Running', muscleGroup: 'Standard', category: 'cardio' },
  { name: 'Rowing machine', muscleGroup: 'Standard', category: 'cardio' },
  { name: 'Cycling', muscleGroup: 'Standard', category: 'cardio' },
  { name: 'Elliptical', muscleGroup: 'Standard', category: 'cardio' },
  { name: 'Jump rope', muscleGroup: 'HIIT', category: 'cardio' },
  { name: 'Stair climber', muscleGroup: 'Standard', category: 'cardio' },
  { name: 'Swimming', muscleGroup: 'Standard', category: 'cardio' },
  { name: 'Brisk walk', muscleGroup: 'Standard', category: 'cardio' },
