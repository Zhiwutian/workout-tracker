...
| [`display-and-accessibility-settings.md`](./display-and-accessibility-settings.md) | **In progress** — Phase 1: `localStorage` + CSS + Profile; Phase 2: `profiles` JSON + `PATCH`/`me` for cross-device sync                                                                                                                          |
